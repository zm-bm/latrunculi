...
For work coordinated in [Engine Development](../../docs/engine-development.md), begin the
experiment name with its lowercase task ID, such as `eng-003-hce`. Preserve historical
`joint-hce-*` names.
