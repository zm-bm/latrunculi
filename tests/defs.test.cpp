...
TEST(Defs_splitStr, ValidInputs) {
    std::string input = "a,b,c";
    std::vector<std::string> expected = {"a", "b", "c"};
    EXPECT_EQ(splitStr(input, ','), expected);
}

TEST(Defs_splitStr, ConsecutiveDelimiters) {
    std::string input = "a,,b,c";
    char delimiter = ',';
    std::vector<std::string> expected = {"a", "", "b", "c"};

    EXPECT_EQ(splitStr(input, delimiter), expected);
}

TEST(Defs_splitStr, WithoutDelimiter) {
...
TEST(Defs_splitStr, EmptyString) {
    std::string input = "";
    char delimiter = ',';
...
TEST(Defs_splitStr, SpecialCharacters) {
