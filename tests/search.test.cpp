...
INSTANTIATE_TEST_SUITE_P(
    Position3PerftTestSuite,
    PerftTest,
    ::testing::Values(std::make_tuple(
        G::POS3, std::vector<long>{14, 191, 2812, 43238, 674624, 11030083})));

INSTANTIATE_TEST_SUITE_P(
    Position4WPerftTestSuite,
    PerftTest,
    ::testing::Values(std::make_tuple(
        G::POS4W, std::vector<long>{6, 264, 9467, 422333, 15833292})));

INSTANTIATE_TEST_SUITE_P(
    Position4BPerftTestSuite,
    PerftTest,
    ::testing::Values(std::make_tuple(
        G::POS4B, std::vector<long>{6, 264, 9467, 422333, 15833292})));

INSTANTIATE_TEST_SUITE_P(
    Position5PerftTestSuite,
    PerftTest,
