...
TEST(SanTest, FormatsOrdinaryMoves) {
...
TEST(SanTest, DisambiguatesByFileRankAndSquare) {
...
TEST(SanTest, IgnoresIllegalMoveWhenDisambiguating) {
    expect_san("4r1k1/8/8/8/8/5N2/4N3/4K3 w - - 0 1", Move(F3, D4), "Nd4");
}

TEST(SanTest, FormatsPromotions) {
