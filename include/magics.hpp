...
constexpr int rookMagicShift[64] = {52, 53, 53, 53, 53, 53, 53, 52, 53, 54, 54, 54, 54, 54, 54, 53,
...
constexpr U64* bishopAttacks[64] = {
    bishopAttacksDB + 4992, bishopAttacksDB + 2624, bishopAttacksDB + 256,  bishopAttacksDB + 896,
    bishopAttacksDB + 1280, bishopAttacksDB + 1664, bishopAttacksDB + 4800, bishopAttacksDB + 5120,
    bishopAttacksDB + 2560, bishopAttacksDB + 2656, bishopAttacksDB + 288,  bishopAttacksDB + 928,
    bishopAttacksDB + 1312, bishopAttacksDB + 1696, bishopAttacksDB + 4832, bishopAttacksDB + 4928,
    bishopAttacksDB + 0,    bishopAttacksDB + 128,  bishopAttacksDB + 320,  bishopAttacksDB + 960,
    bishopAttacksDB + 1344, bishopAttacksDB + 1728, bishopAttacksDB + 2304, bishopAttacksDB + 2432,
    bishopAttacksDB + 32,   bishopAttacksDB + 160,  bishopAttacksDB + 448,  bishopAttacksDB + 2752,
    bishopAttacksDB + 3776, bishopAttacksDB + 1856, bishopAttacksDB + 2336, bishopAttacksDB + 2464,
    bishopAttacksDB + 64,   bishopAttacksDB + 192,  bishopAttacksDB + 576,  bishopAttacksDB + 3264,
    bishopAttacksDB + 4288, bishopAttacksDB + 1984, bishopAttacksDB + 2368, bishopAttacksDB + 2496,
    bishopAttacksDB + 96,   bishopAttacksDB + 224,  bishopAttacksDB + 704,  bishopAttacksDB + 1088,
    bishopAttacksDB + 1472, bishopAttacksDB + 2112, bishopAttacksDB + 2400, bishopAttacksDB + 2528,
    bishopAttacksDB + 2592, bishopAttacksDB + 2688, bishopAttacksDB + 832,  bishopAttacksDB + 1216,
    bishopAttacksDB + 1600, bishopAttacksDB + 2240, bishopAttacksDB + 4864, bishopAttacksDB + 4960,
    bishopAttacksDB + 5056, bishopAttacksDB + 2720, bishopAttacksDB + 864,  bishopAttacksDB + 1248,
    bishopAttacksDB + 1632, bishopAttacksDB + 2272, bishopAttacksDB + 4896, bishopAttacksDB + 5184};
...
constexpr U64 getRookAttacks(Square sq, U64 occupied) {
    auto occupancy = occupied & Magics::rookMagicMask[sq];
    auto index     = (occupancy * Magics::rookMagicNum[sq]) >> Magics::rookMagicShift[sq];
    return Magics::rookAttacks[sq][index];
}

constexpr U64 getBishopAttacks(Square sq, U64 occupied) {
    auto occupancy = occupied & Magics::bishopMagicMask[sq];
    auto index     = (occupancy * Magics::bishopMagicNum[sq]) >> Magics::bishopMagicShift[sq];
