...
constexpr size_t DEFAULT_HASH_MB = 4;
...
constexpr Square RookOrigin[N_CASTLES][N_COLORS]      = {{H8, H1}, {A8, A1}};
constexpr Square RookDestination[N_CASTLES][N_COLORS] = {{F8, F1}, {D8, D1}};
